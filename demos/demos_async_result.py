...
def produce(entity):
	...
	for item in entity:
		if item == 'foo':
			sc.package_item(handler=nirvana.default_handler, url='foo-api', content='say foo!')
		elif item == 'bar':
			sc.package_item(handler=nirvana.default_handler, url='bar-api', content='say bar!')
