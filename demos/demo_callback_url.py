...
def enter(entity):
	...
	for item in entity:
		if item == 'foo':
			sc.package_item(nirvana.default_handler, 'foo-api', 'say foo!', callback_url="http://httpbin.org/anything")
		elif item == 'bar':
			sc.package_item(nirvana.default_handler, 'bar-api', 'say bar!', callback_url="http://httpbin.org/anything")
